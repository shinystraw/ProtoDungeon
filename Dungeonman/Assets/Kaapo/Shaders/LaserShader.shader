Shader "Custom/LaserShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                _CircleSize = 1; //Size of outer circle (0.25 is max size)
                _GradientIntensity = 16; //Intensity of shadowing effect

                fixed4 col = tex2D(_MainTex, i.uv);
                col = fixed4(1,1,1,1); //basic color of shader is black
